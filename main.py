...
CORRECT_TEXT = ["Correct!", "That is right.", "You're right.", "You got it.", "Righto!", "There we go, that's correct!"]
INCORRECT_TEXT = ["Incorrect!", "Nope, that isn't it.", "Nope.", "Not quite.", "You missed it.", "Brilliant, TRY AGAIN!!"]
...
''')
    ...
    for questionNumber, qa in enumerate(QUESTIONS):
        ...
        correct = False
        for acceptWord in qa['accept']:
            if acceptWord in response:
                correct = True
